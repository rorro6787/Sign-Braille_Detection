...
def main():
    import gdown
    url = 'https://drive.google.com/uc?export=download&id=1Z77Jjx-cunEoE2jFJV7ohnkpU1AA6RO4'
    gdown.download(url,"sign.zip",quiet=False)

    ruta_zip = cd + '/sign.zip'
    ruta_destino = cd + str('/sign_dataset')
